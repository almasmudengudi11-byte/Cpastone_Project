    ...
    <div className="page" style={{ overflowY: 'auto', display: 'block', paddingBottom: '4rem' }}>
      ...
      <header style={{
        ...
        <div className="animate-in" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', marginTop: '1rem' }}>
            {user ? (
              <Link id="btn-cta-dashboard" to="/home" className="btn btn-primary" style={{ padding: '1rem 2rem', borderRadius: 'var(--radius-md)' }}>
                Book a Ride Now
              </Link>
            ) : (
              <>
                <Link id="btn-cta-rider" to="/login" className="btn btn-primary" style={{ padding: '1rem 2rem', borderRadius: 'var(--radius-md)' }}>
                  Request a Ride
                </Link>
                <a href="http://localhost:5174" target="_blank" rel="noreferrer" className="btn btn-ghost" style={{ padding: '1rem 2rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--border)' }}>
                  Drive & Earn
                </a>
              </>
            )}
      ...
      <section style={{ maxWidth: 1200, margin: '0 auto', padding: '0 2rem' }}>
        <div className="card" style={{
          ...
          <a href="http://localhost:5174" target="_blank" rel="noreferrer" className="btn btn-primary" style={{ padding: '1rem 2rem', borderRadius: 'var(--radius-md)', background: '#f59e0b', color: '#000', fontWeight: 800 }}>
            Join as Driver
          </a>
        </div>
      </section>
